...
Code for the MotionBand hardware.
...
For the versions available, see [this repository's tags](https://github.com/MD2Korg/MotionBand_HW_code/tags).

## Contributors

Link to the [list of contributors](https://github.com/MD2Korg/MotionBand_HW_code/graphs/contributors) who participated in this project.
