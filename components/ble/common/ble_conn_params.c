    ...
    switch (p_ble_evt->header.evt_id)
    {
        case BLE_GAP_EVT_CONNECTED:
            on_connect(p_ble_evt);
						min_conn = 1.25*p_ble_evt->evt.gap_evt.params.connected.conn_params.min_conn_interval;
						max_conn = 1.25*p_ble_evt->evt.gap_evt.params.connected.conn_params.max_conn_interval;
        ...
        case BLE_GAP_EVT_CONN_PARAM_UPDATE:
            on_conn_params_update(p_ble_evt);
						min_conn = 1.25*p_ble_evt->evt.gap_evt.params.conn_param_update_request.conn_params.min_conn_interval;
						max_conn = 1.25*p_ble_evt->evt.gap_evt.params.conn_param_update_request.conn_params.max_conn_interval;
						NRF_LOG_PRINTF("Min: %ums\tMax: %ums\r\n",min_conn,max_conn);
            break;
